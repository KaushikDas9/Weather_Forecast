...
class _Home1State extends State<Home1> {
  ...
  Future<void> loadweatherInfo(String location) async {
    ...
    print(
        " fellslike: ${getInfo.fellsLikeTemp} ,  temp: ${getInfo.temp} , country: ${getInfo.country},  condition: ${getInfo.condition}, pressure: ${getInfo.pressure_mb},huminidity: ${getInfo.humidity},wind: ${getInfo.wind_kph},");
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(
                                      left: 10.0, top: 10),
                                  child: Text("in $location($conntry) ",
                                      style: const TextStyle(
                                          fontSize: 18,
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold)),
                    ...
                    const Spacer(),
                    const Text("Made by kaushik",
                        style: TextStyle(
                            fontSize: 20,
                            color: Colors.white,
                            fontWeight: FontWeight.bold)),
                    const Text("Data Provides By Weatherapi",
                        style: TextStyle(
                            fontSize: 20,
                            color: Colors.white,
                            fontWeight: FontWeight.bold))
